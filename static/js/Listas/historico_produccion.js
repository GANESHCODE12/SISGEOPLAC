...
function generate_report() {
        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    if (row.aprobacion_orden === false) {
                        ...
                        var buttons = '<a href="actualizar/orden-' + row.numero_op + '"><button title="Actualizar orden" class="btn btn-warning btn-xs btn-flat"><i class="fas fa-edit"></i></button></a> ';
                        buttons += '<a href="detalle-historico-ordenes/orden-' + row.numero_op + '"><button title="Detalle orden" class="btn btn-primary btn-xs btn-flat"><i class="fas fa-eye"></i></button></a> ';
    ...
    $('#data tbody').on('click', 'a[rel=details_controls]', function () {
        var tr = tblHistoricoProduccion.cell($(this).closest('td, li')).index();
        var data = tblHistoricoProduccion.row(tr.row).data();
