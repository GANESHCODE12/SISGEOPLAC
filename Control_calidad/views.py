...
class CertificadoCalidadView(LoginRequiredMixin, ValidatePermissionRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        fecha_creacion = inspeccion.numero_op.fecha_creacion
        fecha_vencimiento = inspeccion.numero_op.fecha_creacion + timedelta(days=730)

        if fecha_vencimiento.month != fecha_creacion.month:
